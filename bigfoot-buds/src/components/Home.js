    ...
    <div>
        ...
        <div className="container my-4 d-flex align-items-center">
          ...
          <nav className="nav justify-content-center flex-grow-1">
            <Link
              ...
              to="/"
              style={{ color: 'black', fontSize: '20px', fontFamily: "'Times New Roman', serif", float: "left" }}
            >
              Home
            </Link>
            <Link
              className="nav-link"
              to="/pages/hybrid"
              style={{ color: 'black', fontSize: '20px', fontFamily: "'Times New Roman', serif" }}
            >
              Hybrid
            </Link>
      ...
      <div class="flex-container">
        <div style={{ width: 'auto', margin: 'auto' }}>
          <h1 className="display-4" style={{ fontFamily: 'Arial, Helvetica, sans-serif' }}>
            The Ultimate
            <span
              className="badge badge-secondary"
              style={{ fontSize: '1.25rem', fontFamily: "'Times New Roman', serif", backgroundColor: 'black' }}
            >
              New
            </span>
          </h1>
          <h2 className="display-4" style={{ fontFamily: 'Arial, Helvetica, sans-serif' }}>
            Trios
          </h2>
          <h3 className="display-4" style={{ fontSize: '2.25rem', fontFamily: 'Arial, Helvetica, sans-serif' }}>
            $299.99
          </h3>
          <h4 style={{ visibility: 'hidden' }}>&nbsp;</h4>
          <h5 className="display-4" style={{ fontFamily: "'Times New Roman', Times, serif", fontSize: '1.25rem' }}>
              ...
              <div className="row">
                <div className="">
                  ...
                  <div className="description-content">
                    <p>
                      The ultimate storage solution for cannabis enthusiasts who demand both quality and style. Crafted with care and wrapped in durable, rustic canvas, these jars are designed to keep your cannabis fresh, potent, and protected.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <section className="mb-4">
              ...
              <div className="description-content">
                <p className="itemContent ingredient">
                  The ultimate storage solution for cannabis enthusiasts who demand both quality and style.
                </p>
              </div>
            </section>
            <hr />
            <section className="mb-4">
              ...
              <div className="description-content">
                <p className="itemContent testimonials">
                  Crafted with care and wrapped in durable, rustic canvas, these jars are designed to keep your cannabis fresh, potent, and protected.
                </p>
              </div>
            </section>
          </div>
